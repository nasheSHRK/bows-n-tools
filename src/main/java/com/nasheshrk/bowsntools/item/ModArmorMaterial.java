...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    RUBY("ruby", 40, new int[] { 3, 6, 8, 3}, 12,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4f, 0.2f,
            () -> {
        return Ingredient.fromItems(ModItems.RUBY.get());
            }),
    TITANIUM("titanium", 38, new int[] { 4, 7, 9, 4}, 14,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 6f, 0.0f,
            () -> {
    ...
    {
        return BowsnTools.MOD_ID + ":" +  this.name;
    }
